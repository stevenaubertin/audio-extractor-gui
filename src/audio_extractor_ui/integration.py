...
This module provides a clean interface to the core audio extraction
functionality from the audio-extractor submodule, making it easy to use
...
def get_core_info() -> Dict[str, Any]:
    ...
    return {
        ...
        "core_path": (
            str(audio_extractor.core_path)
            if audio_extractor.core_path
            else None
        ),
    }
